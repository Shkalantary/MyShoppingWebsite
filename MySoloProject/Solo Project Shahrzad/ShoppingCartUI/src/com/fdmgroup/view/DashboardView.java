...
////
////	private Scanner scanner;
////	private com.fdmgrouop.controller.AuthenticationController authenticationController;
////	
////	public DashboardView() {
////		super();
////	}
...
////	}
////
////	public DashboardView(Scanner scanner, com.fdmgrouop.controller.AuthenticationController authenticationController) {
////		super();
////		this.scanner = scanner;
////		this.authenticationController = authenticationController;
////	}
...
////		System.out.println("Welcome " + UserSession.getLoggedInUser().getFirstname() + " " + UserSession.getLoggedInUser().getLastname() + "!");
////		System.out.println("Please select one of the options below: ");
////		System.out.println("1) Logout");//add options
////		String userInput = scanner.nextLine();
////		
////		switch (userInput) {
////		case "1"://log out
...
//////			break;
//////		case "3"://register
//////			authenticationController.register(username, password, firstname, lastname);
//////			break;
////		default:
////			System.out.println("The input was invalid.");
////			showDashboard();
...
////	}
////
////	public com.fdmgrouop.controller.AuthenticationController getAuthenticationController() {
////		return authenticationController;
////	}
////
